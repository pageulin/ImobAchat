 ...
 */
@WebServlet("/SubmitPropertiesServlet")
public class SubmitPropertiesServlet extends HttpServlet {
    ...
    */
     ...
     */
    public SubmitPropertiesServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher( "/WEB-INF/jsp/submit-property.jsp" ).forward(request, response);
	}
